    ...
    <div className="relative">
      ...
      >
        <div className="h-full overflow-y-auto p-6 flex flex-col">
          ...
          {/* CLOSE */}
          {closeButton && (
            <div className="mb-6 w-fit">{closeButton(() => setIsOpen(false))}</div>
          )}
            ...
            <div className="bg-blue-900 rounded-2xl p-5 flex flex-col gap-3">
              {mainLinks.map((item, i) => (
                <div key={i} className="group flex items-center gap-4">
                  ...
                  <Link
                    href={item.href || "/"}
                    className="group bg-blue-100 rounded-xl px-4 py-3 shadow-sm h-[80px] w-full xl:w-1/2 flex items-center transition-all duration-300 hover:bg-pink-200"
                  >
                    <Typography variant="body-xl" className="!text-blue-900 !font-semibold flex items-center gap-3">
                      {/* Bullet → Arrow */}
                      <span className="relative w-5 h-5 flex items-center justify-center">
                        <span className="absolute transition-all duration-300 opacity-100 group-hover:opacity-0">
                          •
                  ...
                  <div className="hidden xl:block min-w-[160px]">
                    <div className="opacity-0 translate-x-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0">
                      <Typography variant="body-xl" className="!text-white !font-semibold">
                        {item.preview}
                      </Typography>
                    </div>
                  </div>
              ...
              <div className="bg-blue-900 rounded-2xl p-2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-[2px]">
                {socialItems.map((item, i) => (
                  ...
                  >
                    ...
                    {/* LABEL */}
                    <div className="absolute bottom-2 left-2">
                      <Typography variant="body-sm" className="!text-blue-900 !font-semibold text-sm">
                        {item.label}
                      </Typography>
                    </div>
                  </Link>
